...
- 关联说明：安装和重载方式见 [`../MAINTENANCE.md`](../MAINTENANCE.md) 与 [`../scripts/README.md`](../scripts/README.md)。
...
- Related docs: see [`../MAINTENANCE.md`](../MAINTENANCE.md) and [`../scripts/README.md`](../scripts/README.md).
