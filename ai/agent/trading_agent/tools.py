...
@tool(args_schema=AccountResolveInput)
...
@tool(args_schema=RecentTradeRecommendationInput)
...
def load_trade_position_context(instrument_id: int) -> str:
...
def get_market_quote(instrument_id: int) -> str:
    ...
    instrument = (
        Instrument.objects.filter(id=instrument_id)
