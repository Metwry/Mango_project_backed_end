...
from ai.services.currency_conversion import convert_currency
from ai.services.position_data import get_position_data
...
class PositionSummaryService:
    ...
    def summarize(self, *, user_id: int, query: str, symbols: list[str] | None = None) -> str:
        position_payload = get_position_data(user_id=user_id, symbols=symbols)
